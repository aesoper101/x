...
func newProvider(t testing.TB) *Provider {
	...
	f.StringP("b", "b", "", "")
	args := []string{
		"/var/folders/mt/m1dwr59n73zgsq7bk0q2lrmc0000gn/T/go-build533083141/b001/exe/asdf",
		"aaaa",
		"-b",
		"bbbb",
		"dddd",
...
func TestProviderMethods(t *testing.T) {
	...
	t.Run(
		"check fallbacks", func(t *testing.T) {
			t.Run(
				"type=string", func(t *testing.T) {
			...
			t.Run(
				"type=bytesize", func(t *testing.T) {
			...
			github := parseOrPanic("https://github.com/ory")
			ory := parseOrPanic("https://www.ory.sh/")

			t.Run(
				"type=url", func(t *testing.T) {
			...
			t.Run(
				"type=request_uri", func(t *testing.T) {
	...
	t.Run(
		"allow integer as duration", func(t *testing.T) {
	...
	t.Run(
		"use complex set operations", func(t *testing.T) {
	...
	t.Run(
		"use DirtyPatch operations", func(t *testing.T) {
...
func TestAdvancedConfigs(t *testing.T) {
	...
	for _, tc := range []struct {
			...
			isValid: true, envs: [][2]string{
				{
					...
					`[{"id":"google","provider":"google","mapper_url":"file:///etc/config/kratos/oidc.google.jsonnet","client_id":"client@example.com","client_secret":"secret"}]`,
				},
		...
		t.Run(
			"service="+tc.stub, func(t *testing.T) {
				setEnvs(t, tc.envs)
