...
import (
	"bytes"
	"github.com/aesoper101/x/diff/diffmyers"
	"os"
	"path/filepath"
	"testing"
...
func TestDiff(t *testing.T) {
	t.Parallel()
	t.Run(
		"delete-and-insert", func(t *testing.T) {
			t.Parallel()
